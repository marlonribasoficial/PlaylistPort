...
struct SpotifyAuth {
    ...
    static func requestAccessToken(code: String, completion: @escaping (String) -> Void) {
    ...
    static func fetchUserPlaylists(accessToken: String, completion: @escaping ([Playlist]) -> Void) {
                       ...
                       let items = json["items"] as? [[String: Any]] {
                        ...
                        for item in items {
                            guard let id = item["id"] as? String,
                                  ...
                                  let totalTracks = tracksInfo["total"] as? Int else { continue }
        ...
        if let url = nextURL { loadPage(url: url) }
    }

    static func fetchPlaylistTracks(accessToken: String, playlistID: String, completion: @escaping ([Music]) -> Void) {
        var allTracks: [Music] = []
    ...
    static func fetchLikedSongs(accessToken: String, completion: @escaping ([Music]) -> Void) {
        var allTracks: [Music] = []
